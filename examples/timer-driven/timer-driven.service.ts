...
> {
   ...
   */
  public level4(entity: MeterReading): AlarmState {
   ...
   */
  public level3(entity: MeterReading): AlarmState {
   ...
   */
  public level2(entity: MeterReading): AlarmState {
   ...
   */
  public level1(entity: MeterReading): AlarmState {
